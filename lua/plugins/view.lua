-- plugins.view
-- 职责：与界面展示相关的插件（winbar / statusline / 文件树 / cmdline UI 等）
return {
  -- winbar
  -- 顶部面包屑导航栏（显示当前文件路径 / LSP 符号路径）
  {
  ...
  -- Status line
  -- 状态栏插件（左下角/右下角显示模式、文件信息、LSP 状态等）
  {
  ...
  -- Improve the ui
  -- 改造内置输入/选择窗口的 UI（如 :LspRename、vim.ui.select）
  {
