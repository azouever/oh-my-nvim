return {
	...
	config = function()
		...
		workspace_dir = "/Users/xukaixuan/.local/share/nvim/lsp/jdt-language-server/workspace_dir/folder"
			.. project_name

		-- Set proper Java executable
		java_cmd = "/Library/Java/JavaVirtualMachines/jdk-17.jdk/Contents/Home/bin/java"
		...
		config = {
			cmd = {
				...
				"-jar",
				"/Users/xukaixuan/.local/share/nvim/lsp/jdt-language-server/jdt-language-server-1.40.0-202409261450/plugins/org.eclipse.equinox.launcher_1.6.900.v20240613-2009.jar",
				"-configuration",
				"/Users/xukaixuan/.local/share/nvim/lsp/jdt-language-server/jdt-language-server-1.40.0-202409261450/config_mac",
				"-data",
        workspace_dir,
			},
			flags = {
